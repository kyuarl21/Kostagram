...
function profileImageUpload(pageUserId, principalId) {
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		//FormData 객체를 이용해서 form 태그의 필드와 값을 key/value 한쌍으로 담음
		...
		$.ajax({
			...
			data: formData,
			contentType: false, //Default인 x-www-form-urlencoded로 파싱되는걸 막음
			processData: false, //contentType을 false로 주면 QueryString으로 자동 설정되므로 그것도 해제
